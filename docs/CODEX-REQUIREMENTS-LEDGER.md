...
> 来源：用户与 Codex 多轮会话 + Hermes 接管确认。从 `~/.codex/sessions/` 提取。
> 空壳/坏功能 = Critical。
...
| C5 | 番茄钟旁时钟时区/高度 | 已用 Asia/Shanghai | 统一 minHeight 卡片 ✅ 已做 |
...
| H7 | 学科名词/数值/公式/标准量 | 名词≥500/大类，数值≥100，公式≥100，标准≥20（中60%外40%）— 分批扩充 |
...
## Agnes API 真实配置（来源：Hermes agnes plugin）

- URL: `https://apihub.agnes-ai.com/v1`（非 platform.agnes-ai.com）
- Model: `agnes-2.5-flash`
- 已写入 `backend/.env.local`
