...
export function getFrameworksByDiscipline(discipline: string): ResearchFramework[] {
  const map: Record<string, string[]> = {
    ...
    '教育学': ['action-research', 'consort', 'survey', 'mixed-methods', 'spider', 'grounded-theory', 'prisma', 'strobe', 'phenomenology', 'ethnography', 'meta-analysis', 'scoping-review'],
    ...
    '理学': ['imrad', 'doe', 'rsm', 'computational-modeling', 'strobe', 'prisma', 'survey'],
    '工学': ['doe', 'rsm', 'imrad', 'computational-modeling', 'case-study', 'survey', 'prisma'],
    '农学': ['doe', 'rsm', 'imrad', 'strobe', 'survey', 'prisma'],
    '医学': ['pico', 'consort', 'prisma', 'strobe', 'tripod', 'stard', 'cheers', 'imrad', 'meta-analysis', 'scoping-review', 'spider'],
    '护理学': ['pico', 'consort', 'prisma', 'strobe', 'tripod', 'cheers', 'spider', 'phenomenology', 'grounded-theory', 'action-research', 'meta-analysis'],
    '公共卫生': ['strobe', 'prisma', 'pico', 'consort', 'cheers', 'computational-modeling', 'survey', 'mixed-methods', 'meta-analysis', 'scoping-review'],
