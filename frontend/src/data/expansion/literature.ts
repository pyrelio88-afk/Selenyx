...
export const LITERATURE_EXTRA: DisciplineExpansion = {
  glossary: [
    ...
    { term: '叙事视角', termEn: 'Narrative Perspective / Point of View', definition: '故事叙述者与故事内容的关系。主要类型：全知视角（叙述者无所不知）、限制性全知（只知一个人物内心）、第一人称（\'我\'叙述）、第二人称（\'你\'叙述，较少见）、客观视角（只描述外在行为不进入内心）。视角选择决定叙事效果和读者距离感。', category: '叙事学' , source: '叙事学叙事视角理论（Genette 1972）' },
    ...
    { term: '互文', termEn: 'Allusion', definition: '文本中对其他文本、人物、事件的引用或暗示，要求读者具备相关知识才能完整理解。如艾略特《荒原》大量引用但丁、莎士比亚、佛教经典。互文丰富了文本层次，也是精英文学与通俗文学区别之一。', category: '文学技法' , source: 'Kristeva (1966) 互文性概念；Bakhtin 对话理论' },
    ...
    { term: '唐宋八大家', termEn: 'Eight Great Prose Masters of Tang and Song', definition: '唐宋两代八位散文大家：韩愈、柳宗元（唐代）+欧阳修、苏洵、苏轼、苏辙、王安石、曾巩（宋代）。韩愈发起古文运动——反对骈文形式主义，恢复先秦两汉散文明道致用传统。苏轼是八大家中文学成就最高者。', category: '中国古典文学' , source: '明代茅坤《唐宋八大家文钞》定名' },
    ...
    { term: '魔幻', termEn: 'The Grotesque', definition: '文学中怪诞、荒谬、不协调的美学范畴——将喜剧与恐怖、美与丑并置。来源：意大利洞窟装饰grotteschi。卡夫卡《变形记》（人变甲虫）是现代文学怪诞的经典。怪诞不是单纯的恐怖或滑稽，而是两者的矛盾统一。', category: '文学理论' , source: '魔幻现实主义文学流派（拉美文学爆炸）' },
