...
export const MANAGEMENT_EXTRA: DisciplineExpansion = {
  glossary: [
    ...
    { term: '墨菲定律', termEn: 'Murphy\'s Law', definition: '\'如果坏事可能发生，它就一定会发生\'。在质量管理中引申为：必须预设错误会发生并建立防护机制——故障树分析FMEA、防呆设计 Poka-Yoke。不是悲观主义而是风险管理思维。', category: '质量管理' , source: 'Murphy 定律（1949 工程安全警示）' },
    ...
    { term: '决策树', termEn: 'Decision Tree', definition: '决策分析工具：以树状图表示决策节点（方块）、机会节点（圆）、结果节点（三角），计算期望值辅助决策。优点：直观展示决策逻辑、可量化不确定性。剪枝防止过拟合——管理决策中常结合敏感性分析。', category: '决策分析' , source: '决策分析理论标准工具' },
...
// ===== R93 gap-fill: 管理学补全12条 =====
    { term: '矩阵组织', termEn: 'Matrix Organization', definition: '员工同时向职能部门经理和项目/产品经理汇报的组织结构。优势：资源灵活配置、跨部门协作。劣势：双重指挥冲突、权责不清。PMO是缓解矩阵冲突的常见机制。', category: '组织设计' , source: '矩阵组织结构理论（Galbraith 1971）' },
    { term: '扁平化组织', termEn: 'Flat Organization', definition: '减少管理层级、扩大管理幅度的组织结构。优势：决策快速、沟通顺畅。适用条件：员工素质高、创新导向。劣势：晋升通道有限、管理幅度过大。', category: '组织设计' , source: '组织扁平化理论（现代组织设计）' },
    ...
    { term: 'ERP系统', termEn: 'Enterprise Resource Planning', definition: '整合企业各业务流程的统一信息系统。核心特征：单一数据库、模块化、实时数据、流程标准化。SAP/Oracle是主要厂商。', category: '信息系统' , source: '企业资源计划 ERP；Gartner (1990) 提出' },
  ],
};
